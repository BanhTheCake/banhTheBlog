...
import { optionSelect } from '@/components/global/InputSelect';
import TextContent from '@/components/global/TextEditor/TextContent';
...
const HandleBlog: FC<HandleBlogProps> = ({
    ...
    const InputSelect = dynamic(
        () => import('@/components/global/InputSelect'),
        {
            ssr: false,
        }
    );
